...
@property(nonatomic, copy) NSString *wsHost;
@property(nonatomic, copy) NSMutableArray *wsUrls;
@property(nonatomic, assign) int wsUrlIndex;

@property(nonatomic, copy) NSString *safBackupUrl;
@property(nonatomic, copy) NSString *cloudflareUrl;
