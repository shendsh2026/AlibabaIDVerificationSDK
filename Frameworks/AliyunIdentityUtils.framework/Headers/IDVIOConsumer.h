...
@class IDVWebSocket; // TODO: (nlutsenko) Remove dependency on SRWebSocket here.

// Returns number of bytes consumed. Returning 0 means you didn't match.
// Sends bytes to callback handler;
typedef size_t (^stream_scanner)(NSData *collected_data);
typedef void (^data_callback)(IDVWebSocket *webSocket,  NSData *data);

@interface IDVIOConsumer : NSObject {
